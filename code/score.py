...
def main():
    ...
    stopwords = set(line.strip() for line in open('C:/Users/chel/PycharmProjects/Cluster-Analysis-master/stopwords_en.txt'))
    ...
    if args.entities == "word2vec":
        model = gensim.models.KeyedVectors.load_word2vec_format('C:/Users/chel/PycharmProjects/Cluster-Analysis-master/model/GoogleNews-vectors-negative300.bin', binary=True)
